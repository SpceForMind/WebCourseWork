...
export class GameManager {
    ...
    draw() { // Отрисовываем объекты на карте
    ...
    updateAll() {
        ...
        // Изменяем расположение объектов и обрабатываем события, которые они вызывают
        for (let i = 0; i < this.objects.length; i++) {
            try {
        ...
        this.drawMap(); // Отрисовывем карту

        this.draw(); // Отрисовываем объекты после изменений над ними
    }
